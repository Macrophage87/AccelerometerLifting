...
class AutoConnectManager(
    ...
    val imuSamples: SharedFlow<com.macrophage.accelerometerlifting.model.ImuSample> = imuClient.samples
    val hrSamples: SharedFlow<com.macrophage.accelerometerlifting.model.HrSample> = hrmClient.samples
